...
#ifndef RS_ACTIONDRAWSTAIRS_H
#define RS_ACTIONDRAWSTAIRS_H
 ...
 */
class RS_ActionDrawStairs : public RS_PreviewActionInterface {
        Q_OBJECT
public:
    /**
     * Action States.
...
public:
    RS_ActionDrawStairs(RS_EntityContainer& container,
                      RS_GraphicView& graphicView);
    virtual ~RS_ActionDrawStairs();
