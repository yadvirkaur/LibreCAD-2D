...
RS_Commands::RS_Commands() {
    ...
    cmdTranslation.insert("star", tr("star"));
    mainCommands.insert(tr("star"), RS2::ActionDrawStar);
    cmdTranslation.insert("s", tr("s"));
    shortCommands.insert(tr("s"), RS2::ActionDrawStar);
