...
void lc_tankdlg::readSettings()
 {
    ...
    QSize size = settings.value("size", QSize(430,140)).toSize();
        ...
        lengthedit->setText( settings.value(" Length", 40).toString() );
        widthedit->setText( settings.value(" Width", 30).toString() );
        heightedit->setText( settings.value(" Height", 45).toString() );
        cycheight->setText( settings.value(" Cylinder Height", 10).toString() );
        cycradius->setText( settings.value(" Cylinder Radius", 5).toString() );
        spaceedit->setText( settings.value(" Spacing between Views", 5).toString() );
